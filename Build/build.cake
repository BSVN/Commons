...
{
    ("BSN.Commons/", "BSN.Commons.csproj", "1.8.0"),
    ("BSN.Commons.PresentationInfrastructure/", "BSN.Commons.PresentationInfrastructure.csproj", "1.8.0"),
    ("BSN.Commons.Orm.EntityFramework/", "BSN.Commons.Orm.EntityFramework.csproj", "1.8.0"),
    ("BSN.Commons.Orm.EntityFrameworkCore/", "BSN.Commons.Orm.EntityFrameworkCore.csproj", "1.8.0")
};
